...
export default function HeroSection() {
  return (
    <div className="h-screen bg-[#0a0a0a] relative overflow-hidden hero-gradient-overlay">
      {/* Header */}
      <header className="absolute top-0 left-0 right-0 z-30 flex justify-between items-center px-10 py-8">
        <div className="text-white text-sm font-medium">© Code by Divyanshi</div>
        <nav className="flex gap-8 items-center">
          <a href="#projects" className="text-white text-sm font-medium hover:opacity-80 transition-all duration-300 hover:scale-105 relative group">
            Projects
            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-current group-hover:w-full transition-all duration-300" />
          </a>
          <a href="#about" className="text-white text-sm font-medium hover:opacity-80 transition-all duration-300 hover:scale-105 relative group">
            About
            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-current group-hover:w-full transition-all duration-300" />
          </a>
          <a href="#contact" className="text-white text-sm font-medium hover:opacity-80 transition-all duration-300 hover:scale-105 relative group">
            Contact
            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-current group-hover:w-full transition-all duration-300" />
          </a>
          <Link to="/case-studies" className="text-white text-sm font-medium hover:opacity-80 transition-all duration-300 hover:scale-105 relative group">
            Case Studies
            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-current group-hover:w-full transition-all duration-300" />
          </Link>
        </nav>
