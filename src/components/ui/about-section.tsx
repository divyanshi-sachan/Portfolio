...
export default function AboutSection3() {
  ...
  return (
    <section className="py-8 px-4" ref={heroRef}>
          ...
          <div className="flex justify-between items-center mb-8 w-[85%] absolute lg:top-4 md:top-0 sm:-top-2 -top-3 z-10">
            ...
            <div className="flex gap-4">
              <TimelineContent
                ...
                className="md:w-10 md:h-10 sm:w-8 w-6 sm:h-8 h-6 border border-white bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center cursor-pointer transition-all duration-300"
              >
          ...
          <div className="flex flex-wrap lg:justify-start justify-between items-center py-3 text-sm">
            ...
            <div className="lg:absolute right-0 bottom-16 flex lg:flex-col flex-row-reverse lg:gap-0 gap-4">
              ...
              >
                ...
                <span className="text-white">higher engagement</span>
