        ...
        <div className="bg-[#0a0a0a]">
            ...
            <main className="mx-auto flex w-full max-w-7xl flex-col gap-12 px-4 pb-16 md:gap-16 md:px-8 md:pb-24">
                <Link
                    ...
                    className="relative hidden w-full overflow-hidden rounded-2xl select-none focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-blue-500 md:block md:h-[580px] lg:h-[720px]"
                >
                    <img src={featuredArticle.thumbnailUrl} alt={featuredArticle.title} className="absolute inset-0 size-full object-cover" />

                    <div className="absolute inset-x-0 bottom-0 w-full bg-gradient-to-t from-black/60 via-black/40 to-transparent pt-24">
                        <div className="flex w-full flex-col gap-6 p-8">
                            <div className="flex flex-col gap-2">
                                <div className="flex gap-4">
                                    <p className="flex-1 text-xl md:text-2xl lg:text-3xl font-semibold text-white">{featuredArticle.title}</p>
                            ...
                            <div className="flex flex-col gap-6 md:flex-row">
                                <div className="flex flex-1 flex-col gap-4 md:flex-row md:gap-8">
                                    <div className="flex flex-col gap-2">
                                        <p className="text-sm font-semibold text-white/80">Written by</p>
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <p className="text-sm font-semibold text-white/80">Published on</p>
                                ...
                                <div className="flex flex-col gap-2">
                                    <p className="text-sm font-semibold text-white/80">File under</p>
                                    <ul className="flex flex-wrap h-auto items-center gap-2">
                ...
                <ul className="grid grid-cols-1 gap-x-8 gap-y-12 md:grid-cols-2 md:gap-y-12 lg:grid-cols-3">
                    {articles.slice(0, isDesktop ? articles.length : 6).map((article, index) => (
